  ...
  return (
    <section className="bg-gray dark:bg-gray-900 w-full pt-24 px-4 md:px-24 flex flex-col items-end md:flex-row relative md:space-x-3">
      <div
        ...
        style={{
          background: `radial-gradient(circle, rgba(147,184,235,1) 28%, rgba(198,210,210,1) 59%)`,
        }}
      ></div>
      <div className="md:w-1/2 md:pt-20 flex flex-col md:justify-start md:items-start z-[1]">
        <div className="md:flex md:flex-col md:w-[30rem]">
          <h2 className="text-5xl xlg:text-[4rem] leading-tight md:leading-tight font-medium text-center md:text-start mb-6 font-sans text-black dark:text-white">
            Find every job <br />
            in one{" "}
            <span className="text-blue-900 tracking-wider">Platform</span>
          </h2>

          <p className="text-gray-600 dark:text-gray text-center md:text-start text-sm leading-6">
        ...
        <div className="flex flex-col gap-5 sm:gap-0 sm:flex-row justify-center md:justify-start items-center sm:items-end sm:space-x-2 my-12">
          <span className="flex flex-col sm:items-end sm:flex-row sm:space-x-2 space-y-4 w-full">
            <input
              className={`px-4 py-2 rounded-full sm:rounded-l-full sm:rounded-r-none basis-1 flex-grow animate__animated ${
                isObserved ? "animate__fadeInLeftBig" : ""
              }`}
              placeholder="Job title"
            />
            <input
              className={`px-4 py-2 rounded-full sm:rounded-none animate__animated ${
                isObserved ? "animate__fadeInLeftBig animate__delay-2s" : ""
              }`}
      ...
      <div className="hidden sm:w-1/2 xlg:flex xlg:justify-end xlg:items-end relative">
        <div className="w-1/3 relative h-[28rem]">
          <a
            ...
            className={`hidden lg:flex justify-center items-center w-9 h-9 absolute rounded-full bg-white top-16 left-0 animate__animated ${
              isObserved ? "animate__flip" : ""
            }`}
          >
            <img
          ...
          <a
            ...
            className={`hidden lg:flex justify-center items-center w-9 h-9 absolute rounded-full bg-white top-48 right-0 animate__animated ${
              isObserved ? "animate__flip" : ""
            }`}
          >
            <img
          ...
          <a
            ...
            className={`hidden lg:flex justify-center items-center w-9 h-9 absolute rounded-full bg-white top-80 inset-x-1/2 animate__animated ${
              isObserved ? "animate__flip" : ""
            }`}
          >
            <img
