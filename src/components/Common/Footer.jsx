...
function Footer() {
  return (
    <footer
      id="footer"
      className="bg-gray-900 dark: py-6 text-slate-300 md:py-12 text-sm leading-loose px-4 md:px-24 flex flex-wrap items-center justify-start gap-y-10 gap-x-28 md:gap-0 justify-items-center md:grid md:grid-cols-5"
    >
